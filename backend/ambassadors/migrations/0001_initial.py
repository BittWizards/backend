    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('gender', models.CharField(choices=[('Male', 'Мужчина'), ('Female', 'Женщина')], max_length=20, verbose_name='Пол')),
                ('education', models.CharField(max_length=1500, verbose_name='Образование')),
                ('work', models.CharField(blank=True, null=True, verbose_name='Работа')),
                ('status', models.CharField(choices=[('Active', 'Активный'), ('Pause', 'На паузе'), ('Clarify', 'Уточняется'), ('Not active', 'Не активный')], max_length=50, verbose_name='Статус')),
                ('created', models.DateTimeField(default=django.utils.timezone.now, verbose_name='Дата и время создания')),
                ('tg_acc', models.CharField(max_length=150, unique=True, verbose_name='Телеграмм аккаунт')),
                ('tg_id', models.IntegerField(blank=True, null=True, verbose_name='Телеграмм id')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('clothes_size', models.CharField(choices=[('XS', 'Xs'), ('S', 'S'), ('M', 'M'), ('L', 'L'), ('XL', 'Xl')], max_length=30, verbose_name='Размер одежды')),
                ('foot_size', models.IntegerField(choices=[(35, '35'), (36, '36'), (37, '37'), (38, '38'), (39, '39'), (40, '40'), (41, '41'), (42, '42'), (43, '43'), (44, '44'), (45, '45')], verbose_name='Размер обуви')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description', models.CharField(max_length=2000, verbose_name='Описание')),
                ('created', models.DateTimeField(null=True, verbose_name='Было отправлено')),
